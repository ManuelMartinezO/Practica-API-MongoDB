...
Listar Todos        GET     /api/games
Obtener Uno         GET     /api/games/:id
Actualizar          PUT     /api/games/:id
Eliminar            DELETE  /api/games/:id
Descargar Archivo   GET     /api/games/:id/download
```
### Tecnologias
![Static Badge](https://img.shields.io/badge/JavaScript-090040?style=for-the-badge&logo=JavaScript&logoColor=FFCC00)
![Static Badge](https://img.shields.io/badge/MongoDB-090040?style=for-the-badge&logo=MongoDB&logoColor=FFCC00)
